...
| [原生设置界面](./native-settings-interface/) | 候选代码完成，等待跨系统与真实环境验收 | 设置窗口使用固定原生侧栏、具体设置项搜索、历史导航和 grouped Form，并保留必要业务可视化。 |
...
| [Mac 官网分享入口](./mac-app-sharing/) | 代码完成，等待人工验收 | “关于 → 更新与支持”提供官网二维码与复制链接，不上传 App 数据。 |
